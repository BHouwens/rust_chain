...
/**
 * This should probably be some kind of Hasher implementation 
 * in order to make it idiomatic, but I don't have the damn time
 */

pub fn get_hash<T>(input: &T) -> Vec<u8> {
...
mod hash_test {
    ...
    use cryptography::hash::{ hash_message, HashAlgorithm };
